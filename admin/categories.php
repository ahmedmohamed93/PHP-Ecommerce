	        	...
	        	<div class="panel panel-default">
	        		<div class="panel-heading">
	        		    ...
	        		    <div class="option pull-right">
	        		    	...
	        		    	<span class="" data-view="full">Full</span> |
	        		   	 ...
	        		   	 foreach ($cats as $cat) {
	        		   	 	...
	        		   	 	echo "<div class='cat'>";
	        		   	 	    ...
	        		   	 	    echo "<div class='hidden-buttons'>";
	        		   	 	      ...
	        		   	 	      echo "<a href='?do=Delete&catid=".$cat['ID']."' class='confirm btn btn-xs btn-danger'><i class='fa fa-close'></i> Delete
	        		   	 	           </a>";
	        		   	 	    echo "</div>";
		        		   	 	...
		        		   	 	echo "<div class='full-view'>";
			        		   	 	...
			        		   	 	if($cat['Visibility'] == 1){ echo "<span class='visibility'>
			        		   	 		       <i class='fa fa-eye'></i> Hidden</span>";}
			        		   	 	if($cat['Allow_Comment'] == 1){echo "<span class='comment'>
			        		   	 		       <i class='fa fa-close'></i> Comment Disable</span>";}
			        		   	 	if($cat['Allow_Ads'] == 1){echo "<span class='advertise'>
			        		   	 		       <i class='fa fa-close'></i> Ads Disable</span>";}
			        		   	echo "</div>";
			        		   	$childCat = getAllFrom("*", "categories", "WHERE Parent={$cat['ID']}",
	        		   	                 "", "ID");
		        		   	 	if(!empty($childCat)){
		        		   	 		...
		        		   	 		echo "<ul class='list-unstyled child-cats'>";
		        		   	 		     foreach ($childCat as $child) {
				        		   	 		echo "<li class='child-link'>
				        		   	 		     ...
				        		   	 		     <a href='?do=Delete&catid=".$child['ID']."' class='show-delete confirm'> Delete
			        		   	 	             </a>
				        		   	 		     </li>";
				        		   	 	 }
		        		   	 		echo "</ul>";
...
<?php
			...
			echo "<div class='container'>";
			    echo "<div class='nice-message'>There's Is No Category To Show</div>";
			    echo '<a class="add-category btn btn-primary" href="categories.php?do=Add"><i class="fa fa-plus"></i> Add Category</a>';
			echo "</div>";
	    }
?>
<?php
					...
					<div class="form-group form-group-lg">
						...
						<div class="col-sm-10 col-md-6">
							<input type="text" name="description" class="form-control" 
							       placeholder="Decribe The Category" />
						</div>
					</div>
...
<?php 
			...
			if ($_SERVER['REQUEST_METHOD'] == 'POST') {
				...
				if(empty($name)){
					$theMsg = '<div class="alert alert-danger">Name Cant Be <strong>Empty</strong></div>';
